...
const spots = [
    ...
    },
    {
        ...
        location: "Las Vegas, NV",
        rating: 5,
        history: "Chef James Trees' Italian neighborhood spot in the Las Vegas Arts District, named for his great-aunt. Multiple-time 'Best Chef Southwest' finalist.",
        ordered: ["Sourdough bread with 10 spreads", "Brunch pizza with quail eggs", "Mortadella & egg sandwich", "Black garlic pasta"],
        verdict: "Smashed it. Supposedly the best sourdough bread ever, and the homemade pasta backs it up.",
        details: "Esther's has always charged for its bread on principle — six different flours go into the sourdough, and it's baked fresh for their sister restaurant too.",
        address: "1131 S Main St, Las Vegas, NV 89104"
    },
    {
        id: 1023,
        title: "Barry's Downtown Prime",
        category: "Exclusive",
        location: "Las Vegas, NV",
        rating: 5,
        history: "Steakhouse inside Circa Resort & Casino on Fremont Street, run by a chef cooking Vegas steaks for 27 years.",
        ordered: ["Mishima Reserve Bone-In Tomahawk ($270)", "Robbins Island Rib Chop ($189)", "Tableside Truffle Lobster Flambé", "Tableside Bananas Foster"],
        verdict: "Pound-for-pound one of the best steakhouse meals in a long time. The chef, sommelier, and dessert guy all 'absolute dogs.'",
        details: "Meat is cooked sous vide then finished over live white oak, cherry, apricot, and almond wood. The lobster flambé alone has 3 lbs of meat and enough truffle butter to 'kill a man.'",
    ...
    },
    {
        ...
        location: "Las Vegas, NV",
        rating: 5,
        history: "Thomas Keller's French bistro on the 10th floor of The Venetian, open since 2004.",
        ordered: ["Crab Eggs Benedict ($39)", "Fried Chicken Sandwich"],
        verdict: "Best XG Benedict ever had — loaded with jumbo lump crab and a hollandaise that's 'the testament of a good chef.'",
        details: "Feels like a museum inside, with hand-painted murals. The bill is steep but the portions justify it.",
    ...
    },
    {
        ...
        category: "Exclusive",
        location: "Las Vegas, NV (Bellagio)",
        rating: 5,
        history: "Jean-Georges Vongerichten's 1930s-speakeasy-style steakhouse overlooking the Bellagio fountains.",
        ordered: ["A5 Japanese Wagyu Filet ($720/12oz)", "Soy Garlic New York Strip", "Molten Lava Cake with Coconut Ice Cream"],
        verdict: "One of the coolest dining experiences ever — soft enough to cut the A5 with a spoon, with dessert served under the fountain show.",
        details: "Got to pick the next song played by the Bellagio fountains from the venue's official songbook — a rare honor, apparently.",
    ...
    },
    {
        ...
        location: "Austin, TX",
        rating: 5,
        history: "The Black family has done Central Texas barbecue in Lockhart since the 1930s; this Austin location has run 24 hours a day for 11 years, smoking 35 briskets at a time.",
        ordered: ["Beef Rib ('Dino Rib')", "Extra Moist Brisket", "Pork Ribs", "Housemade Jalapeño Cheese Sausage"],
        verdict: "Probably the best barbecue tasted in a lifetime — the beef rib alone is an emotional experience.",
        details: "Sourced from Akaushi cattle (half Black Angus, half American Wagyu) for extra fat content. Sold 530 briskets in a single day the previous Friday.",
    ...
    },
    {
        ...
        location: "New York, NY",
        rating: 5,
        history: "Owner Frank Tuttolomondo's pizzeria, adapted from his grandmother's recipe, using a 75-80 lb imported DOP Parmesan wheel shaved fresh onto every slice.",
        ordered: ["Classic Cheese Slice", "Buffalo Chicken Slice", "Angry Nonna (hot honey)", "Philly Cheesesteak Sandwich"],
        verdict: "Sits on the Iron Throne of NYC pizza — no flop zone, and the cheesesteak rivals Philadelphia's best.",
        details: "Goes through 10-12 imported Parmesan wheels a week, all hand-grated fresh per slice, not pre-shredded.",
        address: "New York, NY"
    },
    {
        id: 1028,
        ...
        rating: 5,
        history: "One of the most iconic, most-recommended spots in Manhattan's Chinatown, famous for hand-chopped roast pork over rice.",
        ordered: ["Roast Pork Over Rice ($7.50)"],
        verdict: "Phenomenal — crispy on the outside with nice fat and juice inside. Probably the best deal in New York City.",
        details: "Cash only, and there's basically always a line, but it moves fast.",
    ...
    },
    {
        ...
        location: "New York, NY (Chinatown)",
        rating: 4.5,
        history: "Family-run Chinatown bakery known for its pineapple roast pork bun, using the same recipe brought over from China decades ago.",
        ordered: ["Pineapple Roast Pork Bun ($2.50)"],
        verdict: "Chinatown does it again — crisp glazed exterior, steamy soft inside, and a better deal than Wah Fung's roast pork.",
        details: "Fresh dough made every morning; the roast pork marinade is a grandmother's recipe.",
    ...
    },
    {
        ...
        location: "New York, NY (Chinatown)",
        rating: 5,
        history: "Run by a woman who's hand-rolled dumplings — including 'no-look' rolling with two hands at once — for over 30 years, reportedly a million-plus dumplings in her lifetime.",
        ordered: ["10 Homemade Pork Dumplings ($4)"],
        verdict: "Just when you think Wah Fung is the best deal in Chinatown, this beats it — crisp bottoms, thin doughy sides.",
        details: "One of the few spots left where the owner still hand-makes everything in-house daily.",
        address: "23 Essex St, New York, NY 10002"
    },
    {
        id: 1031,
        ...
        location: "New York, NY (Chinatown)",
        rating: 4,
        history: "A Fuzhou-style Chinatown spot known for homemade peanut butter noodles.",
        ordered: ["Peanut Butter Noodles ($3.50)"],
        verdict: "Extremely peanut-buttery — a full meal for two people if you love peanut butter, skip it if you don't.",
        details: "Comes with housemade chili oil on the side; nearly every Chinatown spot has its own version, but this one leans hardest into the peanut flavor.",
    ...
    },
    {
        ...
        location: "New York, NY (Chinatown)",
        rating: 5,
        history: "Personal favorite Chinatown spot, cooking classic Cantonese roast meats since 1981 despite the misleading 'noodletown' name.",
        ordered: ["Roast Duck Over Rice ($8.50)", "Wonton Soup ($8.50)"],
        verdict: "Some of the better wonton soup in all of Chinatown — thin wontons stuffed with real shrimp, rich broth.",
        details: "Don't be fooled by the name — the roast meats are the real draw, not just noodles.",
    ...
    },
    {
        ...
        location: "New York, NY",
        rating: 5,
        history: "The only Michelin-starred noodle shop in America, six stars running. 'Jeju' means skill, talent, and ability — the octopus logo represents intelligence.",
        ordered: ["Uni & Caviar Sambap", "Fried Chicken with Caviar", "St. Louis Ribs with Jajang Glaze", "Wagyu Ramen", "Lobster Noodle Bowl"],
        verdict: "Absolutely crushed it — every dish got better than the last, from a $15 fried chicken sandwich to a lobster noodle bowl that might be the city's best.",
        details: "The lobster noodle base cooks down for 4 hours; the broths for the noodle bowls simmer for 3.",
    ...
    },
    {
        ...
        location: "Bronx, NY",
        rating: 5,
        history: "Family-run Italian deli owned by Carolina DiFuccia, creator of the viral 'Italian ice cream cone' — meatballs and fresh mozzarella stuffed into a hollowed loaf, topped with parmesan 'sprinkles.'",
        ordered: ["Italian Ice Cream Cone Sandwich", "Chicken Cutlet with Fresh Mozzarella & Tomato Salad"],
        verdict: "Officially the best Italian deli in New York — the fresh mozzarella alone rivals what's made in Italy.",
        details: "Joe Rogan is a regular; the deli even has a custom 'Joe Rogan sandwich' menu and caters him when he's in town.",
        address: "1928 Williamsbridge Rd, Bronx, NY 10461"
    },
    {
        id: 1035,
        title: "New World Mall",
        category: "Global",
        location: "Flushing, Queens, NY",
        rating: 5,
        history: "A 35,000 sq ft Asian food court with roughly 35 vendors, considered one of the biggest breeding grounds of Asian food culture in NYC.",
        ordered: ["Pan-Fried Pork & Bow Buns (8 for $10)", "Hand-Pulled Beef Noodles ($10)", "Sweet & Sour Whole Fish ($25)", "Live Crab Clay Pot"],
        verdict: "Hands-down some of the best dumplings tried anywhere — a dish that would run $100 in Manhattan costs a fraction here.",
        details: "Almost no vendor here has an English menu, which is treated as a good sign of authenticity, not a barrier.",
    ...
    },
    {
        ...
        location: "London, UK",
        rating: 5,
        history: "Two-Michelin-star Indian restaurant, first starred the year after opening in 2013 and named one of London's top three restaurants by Gordon Ramsay.",
        ordered: ["Golgappa", "Aloo Chaat", "Tandoori Lamb Chops", "Slow-Roasted Leg of Lamb", "Butter Chicken & Garlic Naan"],
        verdict: "Gymkhana is the truth — a top-three butter chicken and probably the best garlic naan ever, but the chef-driven dishes are what set it apart.",
        details: "The kitchen prepared an off-menu whole roasted leg of lamb for the table — reportedly never served before.",
    ...
    },
    {
        ...
        title: "Ginger Pig",
        category: "Global",
        location: "London, UK (Borough Market)",
        rating: 5,
        history: "A full-fledged butcher shop at Borough Market with its own dry-aging room, said to make the best sausage roll in the UK.",
        ordered: ["Sausage Roll"],
        verdict: "The best sausage roll tried, full stop — warm, packed with nutmeg-spiced sausage, and an explosion of fat and juice on the first bite.",
        details: "Ask for it warm — a cold sausage roll apparently 'ruins it.'",
        address: "Borough Market, London SE1 9AL, UK"
    },
    {
        id: 1038,
        title: "Richard Haward's Oysters",
        category: "Global",
        location: "London, UK (Borough Market)",
        rating: 4.5,
        history: "Oyster stall at Borough Market known for some of the largest oysters around, shucked fresh by a team of three.",
        ordered: ["Fresh Oysters", "Giant Oyster (3x normal size)"],
        verdict: "Outstanding — super salty, with herby vinegar sauces that cut the brine perfectly.",
        details: "Point at what you want from the bin; the extra-large oyster is a running dare among visitors.",
        address: "Borough Market, London SE1 9AL, UK"
    },
    {
        id: 1039,
        ...
        location: "London, UK (Borough Market)",
        rating: 4.5,
        history: "Borough Market bakery famous for made-to-order creme brulee doughnuts, dough visible through a huge front window.",
        ordered: ["Crème Brûlée Doughnut"],
        verdict: "Not too sweet despite looking like a sugar bomb — a beautiful display of texture with a torched, campfire-smoky top.",
        details: "Stuffed with vanilla custard, topped with more custard, then torched with brown sugar to order.",
        address: "Borough Market, London SE1 9AL, UK"
    },
    {
        id: 1040,
        ...
        location: "London, UK (Borough Market)",
        rating: 5,
        history: "Borough Market porchetta sandwich stall that reportedly moves over 2,000 sandwiches a day.",
        ordered: ["Porchetta Ciabatta Sandwich"],
        verdict: "One of the best sandwiches in the whole of London — 12-hour slow-cooked pork, crispy crackling, and a mountain of shaved parmesan.",
        details: "Comes with housemade salsa verde, chipotle mayo, and truffle mayo — a sandwich style not really found in the US.",
        address: "Borough Market, London SE1 9AL, UK"
    },
    {
        id: 1041,
        ...
        location: "Axpe, Spain",
        rating: 5,
        history: "Chef Victor Arguinzoniz's Basque Country restaurant, consistently ranked top two in the world, where literally every ingredient touches an open flame he custom-built the grills for.",
        ordered: ["Green Pea Broth", "Palamós Prawn ($40 each)", "Grilled Sea Urchin", "10-Year-Old Galician Beef"],
        verdict: "The best steak ever eaten, hands down — five of six people at the table agreed. Worth a flight back just for this cut alone.",
        details: "Only one seating a day; the restaurant won't open unless the chef himself is present. €280 tasting menu.",
        address: "Plaza San Juan 1, 48291 Axpe, Atxondo, Bizkaia, Spain"
    },
    {
        id: 1042,
        title: "Devorare",
        ...
        rating: 5,
        history: "Madrid's highest-rated sandwich shop, homemaking its own focaccia bread and burrata from scratch at its own facility, grown from 1 to 9 locations in about a year.",
        ordered: ["Mortadella, Burrata, Pistachio & Honey Sandwich"],
        verdict: "Top three sandwiches of the entire trip, including Florence — the honey drizzle balances the mortadella's saltiness perfectly.",
        details: "The honey topping wasn't originally on the menu; it was added permanently after viewers kept requesting it following an earlier video.",
        address: "Calle de Augusto Figueroa 18, 28004 Madrid, Spain"
    },
    {
        id: 1043,
        ...
        rating: 4.5,
        history: "The most famous sandwich shop in Florence, now with over 50 locations worldwide, running three separate storefronts on the same block to keep up with demand.",
        ordered: ["Prosciutto, Burrata, Truffle Cream & Spicy Eggplant Sandwich"],
        verdict: "Great, but the most touristy of the Florence crawl — the bread isn't pressed here since the line moves too fast to slow down for it.",
        details: "You'll see more people in Florence holding an All'Antico Vinaio sandwich than holding an iPhone.",
        address: "Via dei Neri 65r, 50122 Firenze, Italy"
    },
    {
        id: 1044,
        title: "I' Girone de' Ghiotti",
        category: "Global",
        location: "Florence, Italy",
        rating: 5,
        history: "A smaller, family-run sandwich shop in Florence sourcing meats and cheeses from Tuscan farms, using a secret homemade schiacciata recipe.",
        ordered: ["Porchetta with Spicy Cream", "Prosciutto, Melted Brie & Truffle Cream", "Off-menu Nutella, Olive Oil & Sea Salt"],
        verdict: "The best Italian-style sandwich in the world — a crunch audible enough to hear from across the room.",
        details: "Grew into Florence's most popular sandwich shop after a single video hit 50 million views.",
        address: "Via dei Cimatori 23, 50122 Firenze, Italy"
    },
    {
        id: 1045,
        title: "Panini Toscani",
        category: "Global",
        location: "Florence, Italy",
        rating: 4.5,
        history: "A tiny sandwich shop tucked directly behind the Duomo, the only stop on the crawl that lets you taste every meat and cheese before ordering.",
        ordered: ["Porchetta, Pecorino, Spicy Peppers & Zucchini Sandwich"],
        verdict: "Genuinely good ingredients despite the prime tourist-trap location — the individually toasted ciabatta sets it apart from the rest of Florence.",
        details: "Uses ciabatta instead of the schiacciata bread nearly every other shop in Florence defaults to.",
        address: "Piazza del Duomo 34/R, 50122 Firenze, Italy"
    },
    {
        id: 1046,
        title: "Schiacciateria de' Neri",
        category: "Global",
        location: "Florence, Italy",
        rating: 4.5,
        history: "A tiny family-run sandwich shop with a pizza oven in back for toasting schiacciata, run day-to-day by the owner's daughter.",
        ordered: ["Mortadella with Stracciatella & Pistachio Cream"],
        verdict: "Maybe the prettiest sandwich of the whole Florence crawl — the stracciatella gives it an almost milky richness.",
        details: "One of the only shops on the crawl that crisps its schiacciata bread in a pizza oven rather than a panini press.",
        address: "Via dei Neri 18r, 50122 Firenze, Italy"
    },
    {
        id: 1047,
        title: "Pino's Sandwiches (Salumeria Verdi)",
        category: "Global",
        location: "Florence, Italy",
        rating: 5,
        history: "Family-run Florence institution — celebrity status locally — run by Pino for 35 years with a secret bread recipe he won't reveal.",
        ordered: ["Custom Sandwich: Porchetta, Pesto, Cooked Onions, Eggplant, Sun-Dried Tomato & Burrata (€7)"],
        verdict: "Everything worked together perfectly — a sandwich this size would run $40 in LA.",
        details: "Pino builds a custom sandwich for regulars based on what he thinks they'll love, no menu needed.",
        address: "Via Giuseppe Verdi 36R, 50122 Firenze, Italy"
    },
    {
        id: 1048,
        title: "Hector's Deli",
        ...
        rating: 5,
        history: "Started by a two-Michelin-star chef who left fine dining to open a 30-square-meter sandwich shop in 2017; credited with setting the blueprint for Melbourne's modern sandwich shop scene.",
        ordered: ["Beef & Pickle (Pastrami) Sandwich", "Roast Pork with Pesto & Red Pepper Vinaigrette", "Fried Chicken Sandwich", "Tuna Melt"],
        verdict: "Four for four — the pastrami is nearly on par with New York's best, and the tuna melt might be the most underrated sandwich going.",
        details: "Makes its own bread, sauces, and even brisket for other dishes in-house; sources produce hyper-locally from Victoria.",
        address: "Melbourne, Australia"
    },
    {
        id: 1049,
        title: "Din Tai Fung (Original Xinyi Location)",
        category: "Global",
        location: "Taipei, Taiwan",
        rating: 5,
        history: "The original location of the world-famous soup dumpling chain, now with nearly 200 locations globally; each xiaolongbao is weighed down to the gram.",
        ordered: ["Xiaolongbao (Soup Dumplings)", "Shrimp Shumai", "Steamed Pork Bun", "Spicy Chili Oil Wontons"],
        verdict: "Lives up to the hype — chefs train for weeks just to perfect the fold on a single dumpling.",
        details: "A single Din Tai Fung location can make around 10,000 soup dumplings a day.",
        address: "No. 194, Section 2, Xinyi Rd, Da'an District, Taipei 106, Taiwan"
    },
    {
        id: 1050,
        ...
        location: "Taipei, Taiwan",
        rating: 4.5,
        history: "Arguably the most famous breakfast spot in Taiwan — lines wrap around the block daily for a full meal that costs less than $2.",
        ordered: ["Scallion Pancake with Egg & Fried Bread ($2)"],
        verdict: "Absolutely delicious — oily, crunchy, and exactly the hangover cure it's famous for being.",
        details: "They can sell out mid-morning, leaving the entire remaining line empty-handed — arrive early.",
        address: "Taipei, Taiwan (near Yongkang Street)"
    },
    {
        id: 1051,
        title: "Le Palais",
        ...
        location: "Taipei, Taiwan",
        rating: 5,
        history: "Three-Michelin-star Cantonese fine dining inside the Palais de Chine Hotel, holding all three stars for eight straight years.",
        ordered: ["Tableside Roasted Duck", "Crispy Rice Shrimp Tempura Spring Roll", "Barbecue Pork Bun", "Baked Crab Shell"],
        verdict: "A full-on spectacle — the duck is wheeled out and lit tableside, and even the barbecue pork rivals New York's best versions of the dish.",
        details: "One of the only restaurants in Taiwan holding three Michelin stars, all for Cantonese cuisine.",
        address: "Palais de Chine Hotel, Taipei, Taiwan"
    },
    {
        id: 1052,
        title: "Ya Ge",
        ...
        location: "Taipei, Taiwan",
        rating: 5,
        history: "One-Michelin-star Cantonese restaurant inside the Mandarin Oriental Taipei, held the star for eight consecutive years.",
        ordered: ["Roasted Duck", "Honey-Glazed Barbecue Pork", "Crispy Air-Fried Chicken", "Baked Crab Shell"],
        verdict: "Possibly the best chicken ever eaten — air-fried then deep-fried, with skin so crisp it looks like duck.",
        details: "Part of a Mandarin Oriental hotel group that at one point held more Michelin stars worldwide than any other hotel chain.",
        address: "3F, Mandarin Oriental Taipei, 158 Dunhua N Rd, Songshan District, Taipei 105, Taiwan"
    },
    {
        id: 1053,
        title: "Wagyu Mafia",
        ...
        location: "Tokyo, Japan",
        rating: 5,
        history: "A members-only dining club famous for its A5 wagyu sando, run by a family passing down recipes for three generations.",
        ordered: ["Original Wagyu Sando"],
        verdict: "The vibe is a party, but the food backs it up — a lot of restaurants can't say the same.",
        details: "The club can auction off outrageous bites tableside — one oyster reportedly went for $1,000.",
        address: "Tokyo, Japan"
    }
];
...
let authToken = localStorage.getItem('journal_token') || null;
let currentUser = null;
let communityRecipes = [];
let communityFilter = { category: 'all', difficulty: 'all', mine: false };
...
function switchView(v) {
    ...
    document.getElementById('tab-community').classList.toggle('active-tab', v === 'community');
    document.getElementById('recipeFilters').classList.toggle('hidden', v !== 'recipes');
    document.getElementById('spotFilters').classList.toggle('hidden', v !== 'spots');
    document.getElementById('communityFilters').classList.toggle('hidden', v !== 'community');
    document.getElementById('shareBtnWrap').classList.toggle('hidden', v !== 'community');

    if (v === 'recipes') {
        document.getElementById('mainTitle').innerText = '71 Master Recipes';
        document.getElementById('mainSubtitle').innerText = 'Technique-driven culinary archive.';
        render(recipes);
    } else if (v === 'spots') {
        document.getElementById('mainTitle').innerText = 'The Travel Log';
        document.getElementById('mainSubtitle').innerText = 'A global database of restaurants visited by Dylan, Nick and Jack.';
        render(spots);
    } else {
        document.getElementById('mainTitle').innerText = 'Community Recipes';
        document.getElementById('mainSubtitle').innerText = 'Shared by fellow cooks. Log in to add your own.';
        communityFilter = { category: 'all', difficulty: 'all', mine: false };
...
// Renders a circular avatar image, or a monogram (first letter) when no photo is set.
// avatarUrl is HTML-escaped before use — a valid base64 data URL never needs the escaped
// characters, so this is a no-op for legitimate images and a hard stop for anything else.
function avatarHtml(username, avatarUrl, sizeClass) {
    if (avatarUrl) {
        return `<img src="${escapeHtml(avatarUrl)}" class="${sizeClass} rounded-full object-cover inline-block align-middle" alt="">`;
    }
    const initial = username ? escapeHtml(username.charAt(0).toUpperCase()) : '?';
    return `<span class="${sizeClass} rounded-full bg-stone-700 text-white inline-flex items-center justify-center align-middle serif">${initial}</span>`;
}

function render(data) {
    const grid = document.getElementById('mainGrid');
    if (data.length === 0) {
        grid.innerHTML = `<p class="col-span-full text-center text-stone-400 italic py-20">Nothing here yet.</p>`;
        return;
    }
    grid.innerHTML = data.map(item => `
        <div class="card-anim group cursor-pointer p-6 rounded-3xl" onclick="openItem(${item.id})">
            <div class="aspect-[4/5] bg-stone-100 rounded-2xl mb-8 relative overflow-hidden flex items-center justify-center">
                <span class="step-num">${escapeHtml(item.title.charAt(0))}</span>
                <div class="absolute top-6 right-6 text-sm font-bold">${item.rating ? getStars(item.rating) : ''}</div>
                ${item.author ? `<div class="absolute top-6 left-6 bg-stone-900 text-white pl-1 pr-3 py-1 rounded-full shadow-sm text-[8px] font-black tracking-widest uppercase flex items-center space-x-1.5">${avatarHtml(item.author, item.authorAvatar, 'w-4 h-4 text-[7px]')}<span>${escapeHtml(item.author)}</span></div>` : ''}
            ...
            <h3 class="serif text-3xl mb-3 group-hover:text-stone-500 transition-colors leading-tight">${escapeHtml(item.title)}</h3>
            <p class="text-stone-400 text-sm italic font-light leading-relaxed line-clamp-2">
                ${escapeHtml(item.intro || item.history)}
            </p>
            <div class="mt-6 pt-6 border-t border-stone-100 flex justify-between items-center text-[9px] font-bold tracking-widest uppercase text-stone-400">
                <span>${escapeHtml(item.difficulty || item.category)}</span>
...
function openItem(id) {
    const data = view === 'recipes' ? recipes : (view === 'spots' ? spots : communityRecipes);
    const item = data.find(i => i.id === id);
    const content = document.getElementById('modalContent');

    if (view === 'recipes' || view === 'community') {
        const isOwner = view === 'community' && currentUser && item.author === currentUser.username;
        content.innerHTML = `
            <div class="grid md:grid-cols-5 h-full">
                <div class="md:col-span-2 bg-stone-50 p-6 sm:p-10 md:p-12 lg:p-20 border-r border-stone-100">
                    ${item.author ? `<div class="flex items-center space-x-2 mb-4">${avatarHtml(item.author, item.authorAvatar, 'w-6 h-6 text-[10px]')}<p class="text-[10px] uppercase font-bold tracking-widest text-stone-400">Shared by ${escapeHtml(item.author)}</p></div>` : ''}
                    <h2 class="text-4xl sm:text-5xl md:text-6xl serif mb-6">${escapeHtml(item.title)}</h2>
                    <p class="text-stone-500 italic mb-12 border-l-2 border-stone-200 pl-4">"${escapeHtml(item.intro)}"</p>
                    <h4 class="text-[10px] uppercase font-bold tracking-widest text-stone-400 mb-6">The Pantry</h4>
                    <ul class="space-y-3 text-sm font-light text-stone-600">${item.ingredients.map(ing => `<li>— ${escapeHtml(ing)}</li>`).join('')}</ul>
                    ${isOwner ? `<div class="mt-10 flex space-x-3">
                        <button onclick="openEditModal(${item.id})" class="flex-1 border border-stone-300 text-stone-700 hover:bg-stone-100 text-[10px] font-bold uppercase tracking-widest px-6 py-4 rounded-full transition">Edit</button>
                        <button onclick="deleteRecipe(${item.id})" class="flex-1 bg-red-600 hover:bg-red-700 text-white text-[10px] font-bold uppercase tracking-widest px-6 py-4 rounded-full transition">Delete</button>
                    </div>` : ''}
                </div>
                <div class="md:col-span-3 p-6 sm:p-10 md:p-12 lg:p-24 overflow-y-auto bg-white">
                    <h4 class="text-[10px] uppercase font-bold tracking-[0.3em] text-stone-300 mb-12 text-center">Execution</h4>
                    <div class="space-y-12">
                        ${item.steps.map((s, i) => `<div class="relative"><span class="step-num absolute -left-8 -top-12 opacity-10">${i+1}</span><p class="text-2xl font-light relative z-10 text-stone-800">${escapeHtml(s)}</p></div>`).join('')}
                    </div>
                    ${item.secret ? `
                    <div class="mt-20 bg-stone-50 p-10 rounded-3xl italic text-sm text-stone-600 border border-stone-100">
                        <strong class="text-stone-900 uppercase tracking-widest text-[10px] block mb-2">Secret Technique</strong> ${escapeHtml(item.secret)}
                    </div>` : ''}
                </div>
            </div>`;
    } else {
        ...
        content.innerHTML = `
            <div class="grid md:grid-cols-5 h-full bg-white">
                <div class="md:col-span-2 bg-stone-50 p-6 sm:p-10 md:p-12 lg:p-20 border-r border-stone-100 flex flex-col justify-between">
                    <div>
                        <div class="text-2xl mb-6">${getStars(item.rating)}</div>
                        <h2 class="text-4xl sm:text-5xl md:text-6xl serif mb-6 leading-tight">${item.title}</h2>
                ...
                <div class="md:col-span-3 p-6 sm:p-10 md:p-12 lg:p-24 flex flex-col justify-center">
...
function currentData() {
    return view === 'recipes' ? recipes : (view === 'spots' ? spots : communityRecipes);
}
...
function search() {
    ...
    const filtered = data.filter(i =>
        ...
        (i.history && i.history.toLowerCase().includes(query)) ||
...
// ---------- Generic confirm modal (logout, delete account, delete recipe) ----------
...
function openConfirmModal({ title, message, confirmText = 'Confirm', danger = true, onConfirm }) {
    ...
    btn.className = `flex-1 text-[10px] font-bold uppercase tracking-widest px-6 py-4 rounded-full text-white transition ${danger ? 'bg-red-600 hover:bg-red-700' : 'bg-stone-900 hover:bg-stone-700'}`;
...
function closeConfirmModal() {
    ...
    // Only release the scroll lock if no other modal is still open behind this one.
    const stillOpen = ['settingsModal', 'shareModal', 'authModal', 'detailModal']
...
function updateAuthUI() {
    ...
    if (currentUser) {
        area.innerHTML = `
            ${avatarHtml(currentUser.username, currentUser.avatar, 'w-7 h-7 text-xs')}
            <span class="text-stone-600">Hi, ${escapeHtml(currentUser.username)}</span>
            <button onclick="openSettingsModal()" class="hover:text-stone-900 transition">Settings</button>
            <button onclick="logout()" class="hover:text-stone-900 transition">Log Out</button>
        `;
    } else {
        area.innerHTML = `
            <button onclick="openAuthModal('login')" class="hover:text-stone-900 transition">Log In</button>
            <button onclick="openAuthModal('register')" class="maps-btn text-[10px] font-bold tracking-widest uppercase px-5 py-2.5 rounded-full">Register</button>
        `;
    }
    updateCommunityFilterUI();
}
...
function toggleAuthMode(mode) {
    ...
    document.getElementById('authToggleLoginText').classList.toggle('hidden', !isLogin);
    document.getElementById('authToggleRegisterText').classList.toggle('hidden', isLogin);
    document.getElementById('authModalTitle').innerText = isLogin ? 'Log In' : 'Sign Up';
    document.getElementById('authModalSubtitle').innerText = isLogin
        ? 'Log in to share your own recipes.'
        : 'Create an account to start sharing recipes.';
    document.getElementById('authError').classList.add('hidden');
    if (isLogin) applyRememberedUsername();
}

// Only the username is ever remembered client-side — never the password. Storing a real
// password in localStorage (even with consent) would mean anyone with access to this
// browser, or any future XSS, could read it back in plain text. The checkbox instead
// controls whether the *username* gets prefilled next time.
function applyRememberedUsername() {
    const remembered = localStorage.getItem('journal_remembered_username');
    const usernameField = document.getElementById('loginUsername');
    const passwordField = document.getElementById('loginPassword');
    const rememberCheckbox = document.getElementById('rememberMe');
    passwordField.value = ''; // never persisted or left over from a previous attempt
    if (remembered) {
        usernameField.value = remembered;
        rememberCheckbox.checked = true;
        // Hint to the browser's own password manager that autofill is welcome here.
        usernameField.setAttribute('autocomplete', 'username');
        passwordField.setAttribute('autocomplete', 'current-password');
    } else {
        usernameField.value = '';
        rememberCheckbox.checked = false;
        // Best-effort signal to discourage the browser from auto-filling saved credentials
        // when the person hasn't opted in. Browsers vary in how strictly they honor this.
...
async function submitLogin(event) {
    ...
    try {
        ...
        if (rememberMe) {
            localStorage.setItem('journal_remembered_username', username);
        } else {
            localStorage.removeItem('journal_remembered_username');
        }

        authToken = data.token;
        currentUser = data.user;
        localStorage.setItem('journal_token', authToken);
        updateAuthUI();
        closeAuthModal();
        showToast(`Welcome back, ${currentUser.username}.`);
        if (pendingShareAfterLogin) { pendingShareAfterLogin = false; openShareModal(); }
    } catch (e) {
...
function logout() {
    openConfirmModal({
        title: 'Log out?',
        message: 'You can always log back in later.',
        confirmText: 'Log Out',
        danger: false,
        onConfirm: doLogout
    });
...
async function doLogout() {
    try {
        await fetch(`${API_BASE}/api/logout`, { method: 'POST', headers: { 'Authorization': `Bearer ${authToken}` } });
    ...
    if (view === 'community') fetchCommunityRecipes();
}
...
async function fetchCommunityRecipes() {
    const grid = document.getElementById('mainGrid');
    grid.innerHTML = `<p class="col-span-full text-center text-stone-400 italic py-20">Loading community recipes…</p>`;
    try {
        const res = await fetch(`${API_BASE}/api/recipes`);
        const data = await res.json();
        communityRecipes = data.recipes || [];
        applyCommunityFilters();
    } catch (e) {
        grid.innerHTML = `<p class="col-span-full text-center text-stone-400 italic py-20">Couldn't load community recipes. Is the server running?</p>`;
    }
}
...
function toggleCommunityCategory(cat) {
    communityFilter.category = (communityFilter.category === cat) ? 'all' : cat;
    applyCommunityFilters();
}

function toggleCommunityDifficulty(diff) {
    communityFilter.difficulty = (communityFilter.difficulty === diff) ? 'all' : diff;
    applyCommunityFilters();
}

function toggleCommunityMine() {
    if (!currentUser) {
        showToast('Log in to filter your own recipes.');
        openAuthModal('login');
        return;
    }
    communityFilter.mine = !communityFilter.mine;
    applyCommunityFilters();
}

function applyCommunityFilters() {
    let data = communityRecipes;
    if (communityFilter.mine && currentUser) data = data.filter(r => r.author === currentUser.username);
    if (communityFilter.category !== 'all') data = data.filter(r => r.category === communityFilter.category);
    if (communityFilter.difficulty !== 'all') data = data.filter(r => r.difficulty === communityFilter.difficulty);
    if (view === 'community') render(data);
    updateCommunityFilterUI();
}
...
function updateCommunityFilterUI() {
    const mineBtn = document.getElementById('cf-mine');
    const mineSlash = document.getElementById('cf-mine-slash');
    if (!mineBtn || !mineSlash) return;
    mineBtn.classList.toggle('hidden', !currentUser);
    mineSlash.classList.toggle('hidden', !currentUser);

    const isDefault = communityFilter.category === 'all' && communityFilter.difficulty === 'all' && !communityFilter.mine;
    setChipActive('cf-all', isDefault);
    setChipActive('cf-mine', communityFilter.mine);
    ['Breakfast', 'Main', 'Dessert'].forEach(cat => setChipActive('cf-cat-' + cat, communityFilter.category === cat));
    ['Easy', 'Medium', 'Hard'].forEach(diff => setChipActive('cf-diff-' + diff, communityFilter.difficulty === diff));
}

let pendingShareAfterLogin = false;
let editingRecipeId = null;

function openShareModal() {
    if (!currentUser) {
        showToast('Please log in to share a recipe.');
        pendingShareAfterLogin = true;
        openAuthModal('login');
        return;
    }
    editingRecipeId = null;
    document.getElementById('shareModalTitle').textContent = 'Share a Recipe';
    document.getElementById('shareModalSubtitle').textContent = 'Posting as';
    document.getElementById('shareSubmitBtn').textContent = 'Publish Recipe';
    document.getElementById('shareError').classList.add('hidden');
    document.getElementById('shareAsUser').textContent = currentUser.username;
    document.getElementById('shareForm').reset();
    document.getElementById('shareIngredients').innerHTML = '';
...
function openEditModal(id) {
    ...
    if (!currentUser || recipe.author !== currentUser.username) {
        showToast('You can only edit your own recipes.');
        return;
    }

    editingRecipeId = id;
    document.getElementById('shareModalTitle').textContent = 'Edit Recipe';
    document.getElementById('shareModalSubtitle').textContent = 'Editing as';
    document.getElementById('shareSubmitBtn').textContent = 'Save Changes';
    document.getElementById('shareError').classList.add('hidden');
    document.getElementById('shareAsUser').textContent = currentUser.username;

    document.getElementById('shareTitle').value = recipe.title;
    document.getElementById('shareCategory').value = recipe.category;
    document.getElementById('shareDifficulty').value = recipe.difficulty;
    document.getElementById('shareIntro').value = recipe.intro || '';
    document.getElementById('shareSecret').value = recipe.secret || '';
...
function addIngredientField(value) {
    const wrap = document.getElementById('shareIngredients');
    const row = document.createElement('div');
    row.className = 'flex space-x-2';
    row.innerHTML = `
        <input type="text" placeholder="e.g. 2 cups Flour" class="share-ingredient flex-1 border border-stone-200 rounded-xl px-4 py-2 text-sm bg-transparent">
        <button type="button" onclick="this.parentElement.remove()" class="text-stone-300 hover:text-stone-900 px-2">&times;</button>
    `;
    if (value) row.querySelector('.share-ingredient').value = value;
    wrap.appendChild(row);
}

function addStepField(value) {
    const wrap = document.getElementById('shareSteps');
    const row = document.createElement('div');
    row.className = 'flex space-x-2';
    row.innerHTML = `
        <textarea placeholder="Describe this step" rows="1" class="share-step flex-1 border border-stone-200 rounded-xl px-4 py-2 text-sm bg-transparent"></textarea>
        <button type="button" onclick="this.parentElement.remove()" class="text-stone-300 hover:text-stone-900 px-2">&times;</button>
    `;
    if (value) row.querySelector('.share-step').value = value;
    wrap.appendChild(row);
}
...
async function submitRecipe(event) {
    ...
    const intro = document.getElementById('shareIntro').value.trim();
    const secret = document.getElementById('shareSecret').value.trim();
    const ingredients = Array.from(document.querySelectorAll('.share-ingredient'))
        .map(i => i.value.trim()).filter(Boolean);
    const steps = Array.from(document.querySelectorAll('.share-step'))
        .map(s => s.value.trim()).filter(Boolean);

    if (!title || ingredients.length === 0 || steps.length === 0) {
        return showShareError('Please add a title, at least one ingredient, and at least one step.');
    }

    try {
        const isEdit = editingRecipeId !== null;
        const url = isEdit ? `${API_BASE}/api/recipes/${editingRecipeId}` : `${API_BASE}/api/recipes`;
        const method = isEdit ? 'PUT' : 'POST';
        const res = await fetch(url, {
            method,
            headers: { 'Content-Type': 'application/json', 'Authorization': `Bearer ${authToken}` },
            body: JSON.stringify({ title, category, difficulty, intro, ingredients, steps, secret })
        });
        const data = await res.json();
        if (!res.ok) return showShareError(data.error || (isEdit ? 'Could not save your changes.' : 'Could not publish your recipe.'));

        closeShareModal();
        showToast(isEdit ? 'Recipe updated!' : 'Recipe published!');
        fetchCommunityRecipes();
    } catch (e) {
        showShareError('Could not reach the server. Please try again.');
    }
}
...
async function doDeleteRecipe(id) {
    try {
        ...
        if (!res.ok) {
            const data = await res.json();
            showToast(data.error || 'Could not delete recipe.');
            return;
        }
        closeModal();
...
async function submitProfileUpdate(event) {
    ...
    try {
        ...
        const data = await res.json();
        if (!res.ok) return showProfileError(data.error || 'Could not update profile.');
        ...
        showProfileError('Could not reach the server. Please try again.');
    }
}
...
async function submitPasswordChange(event) {
    ...
    if (newPassword !== confirmPassword) {
        return showPasswordError('New passwords do not match.');
    }
    ...
    try {
        ...
        const data = await res.json();
        if (!res.ok) return showPasswordError(data.error || 'Could not change password.');

        // The server invalidates all sessions on password change (including this one) and
        // issues a fresh token, so this browser needs to start using it immediately.
        if (data.token) {
            authToken = data.token;
            localStorage.setItem('journal_token', authToken);
        }
        ...
        document.getElementById('passwordForm').reset();
        showToast('Password changed. You\u2019ve been logged out on other devices.');
    } catch (e) {
        showPasswordError('Could not reach the server. Please try again.');
    }
}
...
function renderAvatarPreview() {
    document.getElementById('avatarPreviewWrap').innerHTML =
        avatarHtml(currentUser.username, currentUser.avatar, 'w-20 h-20 text-2xl');
    document.getElementById('removeAvatarBtn').classList.toggle('hidden', !currentUser.avatar);
}

// Reads an image file, downsizes it in a canvas, and returns a small JPEG data URL —
// keeps upload payloads small without needing any server-side image library.
function readAndResizeImage(file, maxDim = 200, quality = 0.85) {
...
async function handleAvatarSelect(event) {
    ...
    if (!file.type.startsWith('image/')) {
        showAvatarError('Please choose an image file.');
        event.target.value = '';
        return;
    }
    ...
    try {
        ...
        showAvatarError('Could not process that image. Please try a different photo.');
    }
    event.target.value = '';
}
...
async function uploadAvatar(dataUrl) {
    try {
        ...
        const data = await res.json();
        if (!res.ok) return showAvatarError(data.error || 'Could not update photo.');
        ...
        showAvatarError('Could not reach the server. Please try again.');
    }
}
...
async function removeAvatar() {
    try {
        ...
        const data = await res.json();
        if (!res.ok) return showAvatarError(data.error || 'Could not remove photo.');
...
function confirmDeleteAccount() {
    openConfirmModal({
        ...
        message: "This permanently deletes your account and every recipe you've shared. This cannot be undone.",
...
async function doDeleteAccount() {
    try {
        ...
        if (!res.ok) {
            const data = await res.json();
            showToast(data.error || 'Could not delete account.');
            return;
        }
        authToken = null;
        currentUser = null;
...
checkAuth().then(() => switchView('recipes'));